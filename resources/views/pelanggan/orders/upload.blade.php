                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content custom-modal">
                            <div class="modal-body text-center">
                                <p>Apakah kamu yakin ingin konfirmasi pesanan ini dan melanjutkan?</p>
                            </div>
                            <div class="modal-footer justify-content-center border-0">
                                <button type="button" class="btn btn-cancel" data-bs-dismiss="modal">Batalkan</button>
                                <button type="submit" class="btn btn-simpan" form="formKonfirmasi">Lanjut</button>
                            </div>
                        </div>
                    </div>
                </div>
